...
public class Main {
	...
	public static void main(String[] args) {
		...
		HeroHash.put("1", new Hero("mage",100,10,10,10,10, new Weapon()));
		HeroHash.put("2", new Hero("guerrier",100,15,5,10,10, new Weapon()));
		HeroHash.put("3", new Hero("tank",100,5,15,10,10, new Weapon()));
		...
		GameEngine Game = new GameEngine(HeroHash,GameDonjon,RoomHash.get("00"),0,10);
		Game.RunGame();
	}
