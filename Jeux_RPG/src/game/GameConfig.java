...
public class GameConfig{
	...
	{	
		...
		Hero[] HeroTab = new Hero[]{
			new Hero("warrior",100,15,7,10,1, 100,new Weapon("sword",1,0,"sword"),new Spell[]{new Spell("reinforce_weapon","offensive",7,15), new Spell("flash","stun",10,1)},"sword"),
			new Hero("tank",125,10,9,10,1, 25,new Weapon("glaive",1,0,"glaive"),new Spell[]{new Spell("shield","defensive",5,1), new Spell("shield_bash","stun",10,2)},"glaive"),
			new Hero("wizard",80,15,5,10,2, 50,new Weapon("staff",1,0,"staff"),new Spell[]{new Spell("fire_ball","offensive",5,15), new Spell("heal","heal",10,15)},"staff")
		};
		...
		//final room
		RoomHash.put("final", new LockedRoom("cave", new Boss("demon",100,14,5,true), null, true, new Item("final key", 0),"11","up"));
		//merchant room
